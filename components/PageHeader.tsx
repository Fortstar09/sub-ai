    ...
    <div className="flex-col justify-start flex gap-10 py-8 px-0 md:py-8 md:px-8 lg:px-24">
      <div className="flex items-center justify-between">
        ...
        {start && (
          <Button
            variant="outline"
            className="p-2 text-xs md:text-base font-semibold text-black1 hover:text-white dark:text-white bg-transparent dark:bg-transparent dark:hover:bg-brand hover:bg-brand dark:border-[#1B1C20] cursor-pointer shadow-none"
          >
            <Link href="/dashboard" className="flex items-center gap-1 md:gap-2">
              <Plus  strokeWidth={2.5} className="size-4.5"/>
              Start a new chat
            </Link>
          </Button>
        )}
